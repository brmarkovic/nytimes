  ...
  return (
    <div className="flex flex-col ">
      <div className="flex flex-row ">
        <div className="flex flex-row items-center flex-auto w-1/6 ml-2">
          <div>
            <button
              type="button"
              onClick={() => {
        ...
        <div className="flex flex-row justify-center flex-auto w-4/6">
          <img
        ...
        <div className="flex flex-row items-center justify-end flex-auto w-1/6 ml-2 mr-2 ">
          <a>
            <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div className="flex flex-row py-1 mt-1 bg-gray-100 border-t border-b border-gray-500">
        <div className="flex w-1/2 px-2 ml-2 text-xs">Thrusday, February 4,2021 </div>
        <div className="flex flex-row w-1/2 divide-x-2 ">
          <div className="flex px-2 ml-2 text-gray-400 border-gray-500 text-4xs">SUBSCRIBE NOW</div>
          <div className="flex px-2 ml-2 text-xs text-gray-400 ">LOG IN </div>
        </div>
      </div>
        ...
        {cx.showMainMenu && (
          <div className="flex">
            {cx.mainMenu.map((rr) => {
              return (
                <button
                  className="p-1 mx-1 font-serif text-xs text-gray-800 bg-gray-300 rounded-lg"
                  type="button"
                  onClick={() => {
                    send({
                      type: rr?.type,
